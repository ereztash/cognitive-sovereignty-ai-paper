...
def plot_trajectory(data, y, ylabel, title, filename):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(FIGURES / filename, format="png", dpi=160)
    plt.close()
...
def main():
    ...
    plot_trajectory(sim, "critical_thinking", "Mean critical thinking score", "Model prediction: critical thinking trajectory", "critical_thinking_trajectory.png")
    plot_trajectory(sim, "cognitive_sovereignty", "Mean cognitive sovereignty score", "Model prediction: cognitive sovereignty trajectory", "sovereignty_trajectory.png")
